...
stackVariable = [salientStates,unsalientStates,decisionState];
stackVariable = stackVariable/length(sampleVecs);
stackVariable = [(1:length(decisionState))',stackVariable];
